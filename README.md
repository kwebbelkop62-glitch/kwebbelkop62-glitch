...
![Typing SVG](https://readme-typing-svg.demolab.com/?lines=Aspiring+Full-Stack+Developer;Building+with+Next.js+%26+Supabase;Open+to+Junior+Dev+Roles+in+Penang)

I'm a Software Engineering (Hons) student at Wawasan Open University (WOU DiGiT), Penang, building full-stack web apps and looking for a junior developer role.

- 🔭 Currently building **CareHub** — a full-stack patient/caregiver appointment tracker (Next.js, Supabase, Postgres RLS)
...
- 🌱 Currently deepening: systems analysis & design, computer architecture, digital commerce
...
- 📫 Reach me: kwebbelkop62@gmail.com

**Tech I work with:**

![Skills](https://skillicons.dev/icons?i=nextjs,react,ts,tailwind,supabase,postgres,vercel,git)
